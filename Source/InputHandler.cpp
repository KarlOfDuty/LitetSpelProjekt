...
bool InputHandler::handleEvents(sf::Window & window, float dt, Player *player)
{
	...
	while (window.pollEvent(windowEvent))
	{
		...
		{
			if (windowEvent.joystickButton.joystickId == controller && windowEvent.joystickButton.button == XBOXA)
			{
